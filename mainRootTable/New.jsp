...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New MainRootTable</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{mainRootTable.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{mainRootTable.create}" value="Create"/>
                <br />
                <br />
