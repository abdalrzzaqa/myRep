...
<f:view>
    <html>
        <head>
            ...
            <title>Editing LkCommericalTrunk</title>
        ...
        <body>
            ...
            <h1>Editing LkCommericalTrunk</h1>
            <h:form>
                ...
                <br />
                <h:commandLink action="#{lkCommericalTrunk.edit}" value="Save">
                ...
                <br />
                <br />
                <h:commandLink action="#{lkCommericalTrunk.detailSetup}" value="Show" immediate="true">
                    <f:param name="jsfcrud.currentLkCommericalTrunk" value="#{jsfcrud_class['com.cl.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][lkCommericalTrunk.lkCommericalTrunk][lkCommericalTrunk.converter].jsfcrud_invoke}"/>
                </h:commandLink>
                <br />
